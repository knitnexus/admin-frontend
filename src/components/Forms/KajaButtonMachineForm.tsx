...
const KajaButtonMachine: React.FC<KajaButtonMachineProps> = ({machinery, setMachinery, onCancel,}) => {
  const [formData, setFormData] = useState<KajaButtonMachineData>(
    machinery || {
      machineType: "Button",
      noOfMachines: 1,
    }
  ...
  const machineTypes: KajaButtonMachineData["machineType"][] = [
    "Kaj(a)",
    "Button",
    "Press button",
    "Others",
  ...
  const handleChange = <K extends keyof KajaButtonMachineData>(
    field: K,
    value: KajaButtonMachineData[K]
  ) => {
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {showCustomTypeInput && (
          <div className="space-y-2">
            <label className="block text-sm font-semibold text-gray-700">
              Enter Custom Machine Type <span className="text-red-500">*</span>
            </label>
            <input
              type="text"
