...
export default function CompanyStep({ form, setForm, onNext }: Props) {
    ...
    const validate = () => {
        ...
        const prodCap=Number(form.productionCapacity);
        if(isNaN(prodCap)|| prodCap<=0) errs.productionCapacity="Production capacity must be positive";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              onChange={handleChange}
              placeholder="Enter production capacity per week"
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
            />
          ...
          <div className="space-y-2">
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 hover:border-blue-400 transition-colors">
              ...
              <p className="mt-2 text-xs text-gray-500">
                Multiple images, PNG or JPG up to 5MB{" "}
              </p>
            </div>
              ...
              <div className="mt-4 grid grid-cols-3 gap-2">
                {form.unitImages.map((file, idx) => (
                  <ImagePreview
                    ...
                    size="w-24 h-24"
                    onRemove={() => {
                      const updated = form.unitImages.filter(
                        (_, i) => i !== idx
                      );
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-600 mt-1">
                  {form.location.address ||
                    `${form.location.latitude.toFixed(
                      6
