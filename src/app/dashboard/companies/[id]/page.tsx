              ...
              {company.machinery.length > 0 && (
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      {company.machinery.length} machine
                      {company.machinery.length !== 1 ? "s" : ""} registered
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                          ...
                          <CardHeader>
                            <div className="flex items-center justify-between">
                              ...
                              <Badge variant="secondary">
                                Qty:{" "}
                                {machine.quantity ||
                                  machine.machineData.noOfMachines}
                              </Badge>
                            </div>
                          </CardHeader>
                          <CardContent>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      ...
                      {company.services.length !== 1 ? "s" : ""} offered
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
              ...
              {company.unitImages.length > 0 && (
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      {company.unitImages.length} images
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-lg">
                      {company.unitSqFeet.toLocaleString()} sq ft
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground mb-2">
                    ...
                    <p className="font-semibold text-lg">
                      {company.productionCapacity.toLocaleString()} 
                    </p>
                  </div>
                </CardContent>
              </Card>
